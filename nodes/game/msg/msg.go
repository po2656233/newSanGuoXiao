...
var ProcessorJson = process.NewProcessorJson()
...
func RegisterMessage(message proto.Message) {
	...
	msgMap[id] = name
	ProcessorJson.Register(message)
	ProcessorJson.SetRouter(message, ServerChanRPC)
}
...
func init() {
	...
	RegisterMessage(&protoMsg.ChineseChessStateReadyResp{})
	...
	RegisterMessage(&protoMsg.DecreaseGameRunReq{})
	RegisterMessage(&protoMsg.DecreaseGameRunResp{})
	...
	RegisterMessage(&protoMsg.BarterCoinReq{})
