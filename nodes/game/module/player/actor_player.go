...
//func (p *actorPlayer) playerSelect(session *cproto.Session, _ *pb.Player) {
//	//response := &pb.PlayererSelectResponse{}
//	//
...
//	if req.Gender > 1 {
//		p.ResponseCode(session, hints.Register03)
//		return
//	}
//
//	// 检查玩家昵称
...
//
//	// 抛出角色创建事件
//	playerCreateEvent := event2.NewPlayerCreate(newPlayerTable.PlayerId, req.PlayerName, req.Gender)
...
//	playerId := req.Value
//	if playerId < 1 {
//		p.ResponseCode(session, hints.Login03)
//		return
//	}
//
//	// 检查并查找该用户下的该角色
...
//
//	// 角色登录事件
//	loginEvent := event2.NewPlayerLogin(p.ActorID(), playerId)
