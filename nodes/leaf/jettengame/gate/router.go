...
func init() {
    ...
    msg.ProcessorProto.SetRouter(&protoMsg.GameItem{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.TableItem{}, game.ChanRPC)
    ...
    msg.ProcessorProto.SetRouter(&protoMsg.RegisterReq{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.RegisterResp{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.LoginReq{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.LoginResp{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.AllopatricResp{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.ReconnectReq{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.ReconnectResp{}, game.ChanRPC)
    ...
    msg.ProcessorProto.SetRouter(&protoMsg.ChooseGameReq{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.ChooseGameResp{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.SettingTableReq{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.SettingTableResp{}, game.ChanRPC)
    ...
    //rpc文件生成的代码
    msg.ProcessorProto.SetRouter(&protoMsg.LoginRequest{}, game.ChanRPC)
    msg.ProcessorProto.SetRouter(&protoMsg.LoginResponse{}, game.ChanRPC)
