...
type User struct {
	...
	Power        int32          `gorm:"column:power;comment:体力能量" json:"power"`                         // 体力能量
	...
	Coin         int64          `gorm:"column:coin;comment:铜钱" json:"coin"`                             // 铜钱
	Money        int64          `gorm:"column:money;comment:余额" json:"money"`                           // 余额
