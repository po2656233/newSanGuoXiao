...
var file_chinesechess_proto_rawDesc = []byte{
	...
	,
...
var file_chinesechess_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_chinesechess_proto_goTypes = []interface{}{
	...
	(*ChineseChessReadyReq)(nil),         // 12: pb.ChineseChessReadyReq
	(*ChineseChessReadyResp)(nil),        // 13: pb.ChineseChessReadyResp
	(*ChineseChessSetTimeReq)(nil),       // 14: pb.ChineseChessSetTimeReq
	(*ChineseChessSetTimeResp)(nil),      // 15: pb.ChineseChessSetTimeResp
	(*ChineseChessAgreeTimeReq)(nil),     // 16: pb.ChineseChessAgreeTimeReq
	(*ChineseChessAgreeTimeResp)(nil),    // 17: pb.ChineseChessAgreeTimeResp
	(*ChineseChessMoveReq)(nil),          // 18: pb.ChineseChessMoveReq
	(*ChineseChessMoveResp)(nil),         // 19: pb.ChineseChessMoveResp
	(*PlayerSimpleInfo)(nil),             // 20: pb.PlayerSimpleInfo
...
var file_chinesechess_proto_depIdxs = []int32{
	...
	20, // 2: pb.ChineseChessResult.redCamp:type_name -> pb.PlayerSimpleInfo
	20, // 3: pb.ChineseChessResult.blackCamp:type_name -> pb.PlayerSimpleInfo
	2,  // 4: pb.ChineseChessSceneResp.board:type_name -> pb.XQBoardInfo
	20, // 5: pb.ChineseChessSceneResp.redCamp:type_name -> pb.PlayerSimpleInfo
	20, // 6: pb.ChineseChessSceneResp.blackCamp:type_name -> pb.PlayerSimpleInfo
	21, // 7: pb.ChineseChessStateReadyResp.times:type_name -> pb.TimeInfo
	21, // 8: pb.ChineseChessStateSetResp.times:type_name -> pb.TimeInfo
	21, // 9: pb.ChineseChessStateConfirmResp.times:type_name -> pb.TimeInfo
	21, // 10: pb.ChineseChessStateStartResp.times:type_name -> pb.TimeInfo
	21, // 11: pb.ChineseChessStatePlayingResp.times:type_name -> pb.TimeInfo
	2,  // 12: pb.ChineseChessStatePlayingResp.nowBoard:type_name -> pb.XQBoardInfo
	21, // 13: pb.ChineseChessStateOpenResp.times:type_name -> pb.TimeInfo
	2,  // 14: pb.ChineseChessStateOpenResp.nowBoard:type_name -> pb.XQBoardInfo
	21, // 15: pb.ChineseChessStateOverResp.times:type_name -> pb.TimeInfo
