 ...
 * @return {number}
 */
proto.pb.ClubApplyDealReq.prototype.getClubid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ClubApplyDealReq.prototype.setClubid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.pb.ClubApplyDealReq.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.ClubApplyDealReq.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.pb.ClubApplyDealResp.prototype.getClubid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ClubApplyDealResp.prototype.setClubid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.pb.ClubApplyDealResp.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.ClubApplyDealResp.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
...
proto.pb.ClubApplyListResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    common_baseinfo_pb.UserInfo.toObject, includeInstance)
  };
...
proto.pb.ClubApplyListResp.prototype.getMansList = function() {
  return /** @type{!Array<!proto.pb.UserInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_baseinfo_pb.UserInfo, 2));
};
...
proto.pb.ClubApplyListResp.prototype.addMans = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.pb.UserInfo, opt_index);
};
 ...
 * @return {number}
 */
proto.pb.ClubInviteDealReq.prototype.getClubid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ClubInviteDealReq.prototype.setClubid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.pb.ClubInviteDealResp.prototype.getClubid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ClubInviteDealResp.prototype.setClubid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
