 ...
 * @return {number}
 */
proto.pb.LoginReq.prototype.getServerid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.LoginReq.prototype.setServerid = function(value) {
 ...
 * @return {string}
 */
proto.pb.LoginReq.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.pb.LoginReq.prototype.setToken = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.pb.LoginReq.prototype.getParamsMap = function(opt_noLazyCreate) {
 ...
 */
proto.pb.LoginReq.prototype.clearParamsMap = function() {
...
proto.pb.LoginResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    inroomid: jspb.Message.getFieldWithDefault(msg, 3, 0),
    intablenum: jspb.Message.getFieldWithDefault(msg, 4, 0),
    openid: jspb.Message.getFieldWithDefault(msg, 5, ""),
    maininfo: (f = msg.getMaininfo()) && common_baseinfo_pb.MasterInfo.toObject(includeInstance, f)
  };
...
proto.pb.LoginResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new common_baseinfo_pb.MasterInfo;
      reader.readMessage(value,common_baseinfo_pb.MasterInfo.deserializeBinaryFromReader);
...
proto.pb.LoginResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      common_baseinfo_pb.MasterInfo.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {number}
 */
proto.pb.LoginResp.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.LoginResp.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.pb.LoginResp.prototype.getPid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.LoginResp.prototype.setPid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional int64 inRoomID = 3;
 * @return {number}
 */
 ...
 * @return {string}
 */
proto.pb.LoginResp.prototype.getOpenid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.pb.LoginResp.prototype.setOpenid = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};


/**
 * optional MasterInfo mainInfo = 6;
 * @return {?proto.pb.MasterInfo}
 */
proto.pb.LoginResp.prototype.getMaininfo = function() {
  return /** @type{?proto.pb.MasterInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.MasterInfo, 6));
};
...
proto.pb.ReconnectResp.prototype.getMaininfo = function() {
  return /** @type{?proto.pb.MasterInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.MasterInfo, 1));
};
