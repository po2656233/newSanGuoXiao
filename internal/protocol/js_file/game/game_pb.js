...
proto.pb.EnterGameResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    userinfo: (f = msg.getUserinfo()) && common_baseinfo_pb.PlayerSimpleInfo.toObject(includeInstance, f)
  };
...
proto.pb.JoinGameReadyQueueResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    common_baseinfo_pb.PlayerSimpleInfo.toObject, includeInstance)
  };
...
proto.pb.JoinGameReadyQueueResp.prototype.getPlayerlistList = function() {
  return /** @type{!Array<!proto.pb.PlayerSimpleInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 3));
};
...
proto.pb.RankingListResp.prototype.getPersonsList = function() {
  return /** @type{!Array<!proto.pb.PlayerSimpleInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 1));
};
...
proto.pb.GameOverResp.toObject = function(includeInstance, msg) {
  var obj = {
    gid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    innings: (f = msg.getInnings()) && common_baseinfo_pb.InningList.toObject(includeInstance, f),
...
proto.pb.GameOverResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new common_baseinfo_pb.InningList;
      reader.readMessage(value,common_baseinfo_pb.InningList.deserializeBinaryFromReader);
...
proto.pb.GameOverResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      common_baseinfo_pb.InningList.serializeBinaryToWriter
    );
  }
...
proto.pb.GameOverResp.prototype.getInnings = function() {
  return /** @type{?proto.pb.InningList} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.InningList, 2));
};
...
proto.pb.GetRecordResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    common_baseinfo_pb.InningInfo.toObject, includeInstance),
...
proto.pb.GetRecordResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new common_baseinfo_pb.InningInfo;
      reader.readMessage(value,common_baseinfo_pb.InningInfo.deserializeBinaryFromReader);
...
proto.pb.GetRecordResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      common_baseinfo_pb.InningInfo.serializeBinaryToWriter
    );
  }
  f = message.getPagenum();
  if (f !== 0) {
...
proto.pb.GetRecordResp.prototype.getInningsList = function() {
  return /** @type{!Array<!proto.pb.InningInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_baseinfo_pb.InningInfo, 5));
};
...
proto.pb.GetInningsInfoResp.prototype.getInningsList = function() {
  return /** @type{!Array<!proto.pb.InningInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, common_baseinfo_pb.InningInfo, 2));
};
