...
goog.exportSymbol('proto.pb.ChineseChessJiangJuResp', null, global);
goog.exportSymbol('proto.pb.ChineseChessJueShaResp', null, global);
goog.exportSymbol('proto.pb.ChineseChessMoveReq', null, global);
goog.exportSymbol('proto.pb.ChineseChessMoveResp', null, global);
goog.exportSymbol('proto.pb.ChineseChessReadyReq', null, global);
goog.exportSymbol('proto.pb.ChineseChessReadyResp', null, global);
...
goog.exportSymbol('proto.pb.ChineseChessStateConfirmResp', null, global);
...
goog.exportSymbol('proto.pb.ChineseChessStateReadyResp', null, global);
goog.exportSymbol('proto.pb.ChineseChessStateSetResp', null, global);
 ...
 * @constructor
 */
proto.pb.ChineseChessStateReadyResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessStateReadyResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessStateReadyResp.displayName = 'proto.pb.ChineseChessStateReadyResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessStateSetResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessStateSetResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessStateSetResp.displayName = 'proto.pb.ChineseChessStateSetResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessStateConfirmResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessStateConfirmResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessStateConfirmResp.displayName = 'proto.pb.ChineseChessStateConfirmResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessJiangJuResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessJiangJuResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessJiangJuResp.displayName = 'proto.pb.ChineseChessJiangJuResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessJueShaResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessJueShaResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessJueShaResp.displayName = 'proto.pb.ChineseChessJueShaResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessReadyReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessReadyReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessReadyReq.displayName = 'proto.pb.ChineseChessReadyReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pb.ChineseChessReadyResp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.ChineseChessReadyResp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ChineseChessReadyResp.displayName = 'proto.pb.ChineseChessReadyResp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pb.ChineseChessResult.toObject = function(includeInstance, msg) {
  var obj = {
    redcamp: (f = msg.getRedcamp()) && common_baseinfo_pb.PlayerSimpleInfo.toObject(includeInstance, f),
    blackcamp: (f = msg.getBlackcamp()) && common_baseinfo_pb.PlayerSimpleInfo.toObject(includeInstance, f)
  };
...
proto.pb.ChineseChessResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new common_baseinfo_pb.PlayerSimpleInfo;
      reader.readMessage(value,common_baseinfo_pb.PlayerSimpleInfo.deserializeBinaryFromReader);
...
proto.pb.ChineseChessResult.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      common_baseinfo_pb.PlayerSimpleInfo.serializeBinaryToWriter
    );
  }
...
proto.pb.ChineseChessResult.prototype.getRedcamp = function() {
  return /** @type{?proto.pb.PlayerSimpleInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 1));
};
...
proto.pb.ChineseChessResult.prototype.getBlackcamp = function() {
  return /** @type{?proto.pb.PlayerSimpleInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 2));
};
...
proto.pb.ChineseChessSceneResp.prototype.getRedcamp = function() {
  return /** @type{?proto.pb.PlayerSimpleInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 4));
};
...
proto.pb.ChineseChessSceneResp.prototype.getBlackcamp = function() {
  return /** @type{?proto.pb.PlayerSimpleInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.PlayerSimpleInfo, 5));
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessStateReadyResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessStateReadyResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessStateReadyResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateReadyResp.toObject = function(includeInstance, msg) {
  var obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessStateReadyResp}
 */
proto.pb.ChineseChessStateReadyResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessStateReadyResp;
  return proto.pb.ChineseChessStateReadyResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessStateReadyResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessStateReadyResp}
 */
proto.pb.ChineseChessStateReadyResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessStateReadyResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessStateReadyResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessStateReadyResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateReadyResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTimes();
  if (f != null) {
    writer.writeMessage(
 ...
 */
proto.pb.ChineseChessStateReadyResp.prototype.getTimes = function() {
...
proto.pb.ChineseChessStateReadyResp.prototype.setTimes = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.pb.ChineseChessStateReadyResp.prototype.clearTimes = function() {
 ...
 * @return {boolean}
 */
proto.pb.ChineseChessStateReadyResp.prototype.hasTimes = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessStateSetResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessStateSetResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessStateSetResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateSetResp.toObject = function(includeInstance, msg) {
  var obj = {
    times: (f = msg.getTimes()) && common_baseinfo_pb.TimeInfo.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessStateSetResp}
 */
proto.pb.ChineseChessStateSetResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessStateSetResp;
  return proto.pb.ChineseChessStateSetResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessStateSetResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessStateSetResp}
 */
proto.pb.ChineseChessStateSetResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessStateSetResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessStateSetResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessStateSetResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateSetResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTimes();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.pb.TimeInfo}
 */
proto.pb.ChineseChessStateSetResp.prototype.getTimes = function() {
  return /** @type{?proto.pb.TimeInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.TimeInfo, 1));
};
...
/** @param {?proto.pb.TimeInfo|undefined} value */
proto.pb.ChineseChessStateSetResp.prototype.setTimes = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.pb.ChineseChessStateSetResp.prototype.clearTimes = function() {
  this.setTimes(undefined);
};
 ...
 * @return {boolean}
 */
proto.pb.ChineseChessStateSetResp.prototype.hasTimes = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.pb.ChineseChessStateSetResp.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.ChineseChessStateSetResp.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessStateConfirmResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessStateConfirmResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessStateConfirmResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateConfirmResp.toObject = function(includeInstance, msg) {
  var obj = {
    times: (f = msg.getTimes()) && common_baseinfo_pb.TimeInfo.toObject(includeInstance, f),
    uid: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessStateConfirmResp}
 */
proto.pb.ChineseChessStateConfirmResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessStateConfirmResp;
  return proto.pb.ChineseChessStateConfirmResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessStateConfirmResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessStateConfirmResp}
 */
proto.pb.ChineseChessStateConfirmResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessStateConfirmResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessStateConfirmResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessStateConfirmResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessStateConfirmResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTimes();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.pb.TimeInfo}
 */
proto.pb.ChineseChessStateConfirmResp.prototype.getTimes = function() {
  return /** @type{?proto.pb.TimeInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.TimeInfo, 1));
};
...
/** @param {?proto.pb.TimeInfo|undefined} value */
proto.pb.ChineseChessStateConfirmResp.prototype.setTimes = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * Clears the message field making it undefined.
 */
proto.pb.ChineseChessStateConfirmResp.prototype.clearTimes = function() {
  this.setTimes(undefined);
};
 ...
 * @return {boolean}
 */
proto.pb.ChineseChessStateConfirmResp.prototype.hasTimes = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.pb.ChineseChessStateConfirmResp.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.ChineseChessStateConfirmResp.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessJiangJuResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessJiangJuResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessJiangJuResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessJiangJuResp.toObject = function(includeInstance, msg) {
  var obj = {
    bejianguid: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessJiangJuResp}
 */
proto.pb.ChineseChessJiangJuResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessJiangJuResp;
  return proto.pb.ChineseChessJiangJuResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessJiangJuResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessJiangJuResp}
 */
proto.pb.ChineseChessJiangJuResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessJiangJuResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessJiangJuResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessJiangJuResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessJiangJuResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBejianguid();
  if (f !== 0) {
    writer.writeInt64(
      1,
      f
...
/**
 * optional int64 beJiangUid = 1;
 * @return {number}
 */
proto.pb.ChineseChessJiangJuResp.prototype.getBejianguid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ChineseChessJiangJuResp.prototype.setBejianguid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessJueShaResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessJueShaResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessJueShaResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessJueShaResp.toObject = function(includeInstance, msg) {
  var obj = {
    bejueshauid: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessJueShaResp}
 */
proto.pb.ChineseChessJueShaResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessJueShaResp;
  return proto.pb.ChineseChessJueShaResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessJueShaResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessJueShaResp}
 */
proto.pb.ChineseChessJueShaResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessJueShaResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessJueShaResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessJueShaResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessJueShaResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBejueshauid();
  if (f !== 0) {
    writer.writeInt64(
      1,
      f
...
/**
 * optional int64 beJueShaUid = 1;
 * @return {number}
 */
proto.pb.ChineseChessJueShaResp.prototype.getBejueshauid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.pb.ChineseChessJueShaResp.prototype.setBejueshauid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessReadyReq.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessReadyReq.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessReadyReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessReadyReq.toObject = function(includeInstance, msg) {
  var obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessReadyReq}
 */
proto.pb.ChineseChessReadyReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessReadyReq;
  return proto.pb.ChineseChessReadyReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessReadyReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessReadyReq}
 */
proto.pb.ChineseChessReadyReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessReadyReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessReadyReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessReadyReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessReadyReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.pb.ChineseChessReadyReq.prototype.getIsready = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.pb.ChineseChessReadyReq.prototype.setIsready = function(value) {
 ...
 * @return {!Object}
 */
proto.pb.ChineseChessReadyResp.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ChineseChessReadyResp.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ChineseChessReadyResp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessReadyResp.toObject = function(includeInstance, msg) {
  var obj = {
    isready: jspb.Message.getFieldWithDefault(msg, 1, false),
    uid: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ChineseChessReadyResp}
 */
proto.pb.ChineseChessReadyResp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ChineseChessReadyResp;
  return proto.pb.ChineseChessReadyResp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ChineseChessReadyResp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ChineseChessReadyResp}
 */
proto.pb.ChineseChessReadyResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.ChineseChessReadyResp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ChineseChessReadyResp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ChineseChessReadyResp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ChineseChessReadyResp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIsready();
  if (f) {
    writer.writeBool(
 ...
 * @return {boolean}
 */
proto.pb.ChineseChessReadyResp.prototype.getIsready = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.pb.ChineseChessReadyResp.prototype.setIsready = function(value) {
  jspb.Message.setProto3BooleanField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.pb.ChineseChessReadyResp.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.pb.ChineseChessReadyResp.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
