...
proto.pb.BrcowcowOpenResp.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    tiancard: (f = msg.getTiancard()) && common_baseinfo_pb.CardInfo.toObject(includeInstance, f),
    xuancard: (f = msg.getXuancard()) && common_baseinfo_pb.CardInfo.toObject(includeInstance, f),
    dicard: (f = msg.getDicard()) && common_baseinfo_pb.CardInfo.toObject(includeInstance, f),
    huangcard: (f = msg.getHuangcard()) && common_baseinfo_pb.CardInfo.toObject(includeInstance, f)
  };
...
proto.pb.BrcowcowOpenResp.prototype.getXuancard = function() {
  return /** @type{?proto.pb.CardInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.CardInfo, 4));
};
...
proto.pb.BrcowcowOpenResp.prototype.getDicard = function() {
  return /** @type{?proto.pb.CardInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.CardInfo, 5));
};
...
proto.pb.BrcowcowOpenResp.prototype.getHuangcard = function() {
  return /** @type{?proto.pb.CardInfo} */ (
    jspb.Message.getWrapperField(this, common_baseinfo_pb.CardInfo, 6));
};
...
proto.pb.BrcowcowHostListResp.toObject = function(includeInstance, msg) {
  var obj = {
    curhost: (f = msg.getCurhost()) && common_baseinfo_pb.PlayerInfo.toObject(includeInstance, f),
