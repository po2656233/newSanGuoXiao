...
proto.pb.SanguoxiaoPlayer.toObject = function(includeInstance, msg) {
  var obj = {
    info: (f = msg.getInfo()) && player_pb.PlayerInfo.toObject(includeInstance, f),
    arenateamList: jspb.Message.toObjectList(msg.getArenateamList(),
    home_pb.HeroInfo.toObject, includeInstance),
...
proto.pb.SanguoxiaoPlayer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new home_pb.HeroInfo;
      reader.readMessage(value,home_pb.HeroInfo.deserializeBinaryFromReader);
...
proto.pb.SanguoxiaoPlayer.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      home_pb.HeroInfo.serializeBinaryToWriter
    );
  }
  f = message.getHealth();
  if (f !== 0) {
...
proto.pb.SanguoxiaoPlayer.prototype.getArenateamList = function() {
  return /** @type{!Array<!proto.pb.HeroInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, home_pb.HeroInfo, 2));
};
...
proto.pb.SanguoxiaoResult.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    awards: (f = msg.getAwards()) && home_pb.GoodsList.toObject(includeInstance, f)
  };
...
proto.pb.SanguoxiaoResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new home_pb.GoodsList;
      reader.readMessage(value,home_pb.GoodsList.deserializeBinaryFromReader);
      msg.setAwards(value);
      break;
    default:
      reader.skipField();
...
proto.pb.SanguoxiaoResult.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      home_pb.GoodsList.serializeBinaryToWriter
    );
  }
};
...
proto.pb.SanguoxiaoResult.prototype.getAwards = function() {
  return /** @type{?proto.pb.GoodsList} */ (
    jspb.Message.getWrapperField(this, home_pb.GoodsList, 3));
};
